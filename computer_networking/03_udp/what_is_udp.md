...
*   [1. Các đặc điểm chính](#các-đặc-điểm-chính)
*   [2. Cách hoạt động: Ghép kênh & Phân kênh (Multiplexing & Demultiplexing)](#cách-hoạt-động-ghép-kênh--phân-kênh-multiplexing--demultiplexing)
*   [3. Ví dụ thực tế](#ví-dụ-thực-tế)
*   [4. Các trường hợp sử dụng phổ biến](#các-trường-hợp-sử-dụng-phổ-biến)
