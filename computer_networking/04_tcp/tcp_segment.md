...
*   [2\. Phân tích Cấu trúc chi tiết của TCP Header](#-phân-tích-cấu-trúc-chi-tiết-của-tcp-header)
*   [3\. Maximum Segment Size (MSS) và mối liên quan với MTU](#-maximum-segment-size-mss-và-mối-liên-quan-với-mtu)
