...
*   [1. Certificate là gì? (Và vấn đề nó giải quyết)](#certificate-là-gì-và-vấn-đề-nó-giải-quyết)
*   [2. Bên trong Certificate có gì? (Tiêu chuẩn X.509)](#bên-trong-certificate-có-gì-tiêu-chuẩn-x509)
*   [3. Cách tạo Certificate: Tự ký (Self-Signed)](#cách-tạo-certificate-tự-ký-self-signed)
*   [4. Giải pháp: Chain of Trust (Chuỗi tin cậy) và CA](#giải-pháp-chain-of-trust-chuỗi-tin-cậy-và-ca)
*   [5. Quy trình Xác thực Chuỗi hoạt động như thế nào?](#quy-trình-xác-thực-chuỗi-hoạt-động-như-thế-nào)
*   [6. Rủi ro bảo mật: Man-in-the-Middle với Root CA giả mạo](#rủi-ro-bảo-mật-man-in-the-middle-với-root-ca-giả-mạo)
*   [7. Tổng kết](#tổng-kết)
