...
*   [1\. Tại sao chúng ta cần DNS?](#-tại-sao-chúng-ta-cần-dns)
*   [2\. Sự kỳ diệu của lớp trừu tượng](#-sự-kỳ-diệu-của-lớp-trừu-tượng)
*   [3\. DNS là một bản đồ ánh xạ (Giống như ARP)](#-dns-là-một-bản-đồ-ánh-xạ-giống-như-arp)
*   [4\. Thông số kỹ thuật của DNS](#-thông-số-kỹ-thuật-của-dns)
*   [5\. DNS hoạt động như thế nào (Kiến trúc phân cấp)](#-dns-hoạt-động-như-thế-nào-kiến-trúc-phân-cấp)
*   [6\. Luồng truy vấn DNS đầy đủ (The Full Flow)](#-luồng-truy-vấn-dns-đầy-đủ-the-full-flow)
*   [7\. Gói tin DNS (Sơ lược)](#-gói-tin-dns-sơ-lược)
*   [8\. Lưu ý quan trọng và Bảo mật](#-lưu-ý-quan-trọng-và-bảo-mật)
*   [9\. Thực hành: "Làm bẩn tay" với `nslookup`](#-thực-hành-làm-bẩn-tay-với-nslookup)
