...
Chúng ta đã nói về Proxy và Reverse Proxy. Giờ đây, chúng ta sẽ đi sâu vào một khái niệm quan trọng bậc nhất đối với kỹ sư backend: sự khác biệt giữa **Bộ cân bằng tải Lớp 4 (Layer 4 Load Balancer)** và **Bộ cân bằng tải Lớp 7 (Layer 7 Load Balancer)**.

Hiểu rõ điều này là then chốt, vì nó là cầu nối trực tiếp giữa kiến thức mạng (L4, L7) và các hệ thống backend thực tế.
