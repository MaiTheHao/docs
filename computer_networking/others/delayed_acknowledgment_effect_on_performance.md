...
Đây là "người anh em họ" của Thuật toán Nagle. **Delayed Acknowledgment (ACK Trì hoãn)** được phát triển gần như cùng lúc với Nagle (những năm 1970-1980) và chúng thường được triển khai cùng nhau.

Và như bạn sẽ thấy, khi cả hai thuật toán này cùng được kích hoạt, đó là một **thảm họa** về hiệu suất.

## Mục lục

1.  [Ý tưởng của Delayed ACK: Tiết kiệm là tốt?](#1-ý-tưởng-của-delayed-ack-tiết-kiệm-là-tốt)
2.  [Thảm họa: Khi Delayed ACK gặp Nagle](#2-thảm-họa-khi-delayed-ack-gặp-nagle)
3.  [Giải pháp: `TCP_QUICKACK`](#3-giải-pháp-tcp_quickack)
