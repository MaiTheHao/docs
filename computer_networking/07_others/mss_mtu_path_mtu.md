...
*   [1. Mối quan hệ Phân cấp: Frame, Packet, và Segment](#mối-quan-hệ-phân-cấp-frame-packet-và-segment)
*   [2. MTU (Maximum Transmission Unit) là gì?](#mtu-maximum-transmission-unit-là-gì)
*   [3. Vấn đề của Fragmentation (Phân mảnh)](#vấn-đề-của-fragmentation-phân-mảnh)
*   [4. MSS (Maximum Segment Size) là gì?](#mss-maximum-segment-size-là-gì)
*   [5. Path MTU Discovery (Khám phá MTU Đường truyền)](#path-mtu-discovery-khám-phá-mtu-đường-truyền)
*   [6. Tổng kết](#tổng-kết)
