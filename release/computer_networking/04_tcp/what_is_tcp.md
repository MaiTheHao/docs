...
*   [1\. Giới thiệu về TCP](#-giới-thiệu-về-tcp)
*   [2\. Khái niệm Kết nối (Connection) trong TCP](#-khái-niệm-kết-nối-connection-trong-tcp)
*   [3\. Thiết lập Kết nối - Three-Way Handshake](#-thiết-lập-kết-nối---three-way-handshake)
*   [4\. Truyền và Nhận Dữ liệu](#-truyền-và-nhận-dữ-liệu)
*   [5\. Xử lý Mất dữ liệu và Truyền lại](#-xử-lý-mất-dữ-liệu-và-truyền-lại)
*   [6\. Đóng Kết nối - Four-Way Handshake](#-đóng-kết-nối---four-way-handshake)
*   [7\. Ghép kênh và Phân kênh (Multiplexing & Demultiplexing)](#-ghép-kênh-và-phân-kênh-multiplexing--demultiplexing)
*   [8\. Các khái niệm & Bổ sung](#-các-khái-niệm--bổ-sung)
