...
*   [1\. TLS nằm ở đâu trong Mô hình OSI?](#-tls-nằm-ở-đâu-trong-mô-hình-osi)
*   [2\. HTTP "Trần" (Vanilla HTTP) - Vấn đề là gì?](#-http-trần-vanilla-http---vấn-đề-là-gì)
*   [3\. HTTPS (HTTP + TLS) - Giải pháp là gì?](#-https-http--tls---giải-pháp-là-gì)
*   [4\. Bài toán "Trao đổi Khóa" (The Key Problem)](#-bài-toán-trao-đổi-khóa-the-key-problem)
*   [5\. TLS 1.2 Handshake (Cách làm của RSA)](#-tls-12-handshake-cách-làm-của-rsa)
*   [6\. Lỗ hổng của RSA: Thiếu "Perfect Forward Secrecy"](#-lỗ-hổng-của-rsa-thiếu-perfect-forward-secrecy)
*   [7\. Giải pháp: Trao đổi khóa Diffie-Hellman (DH)](#-giải-pháp-trao-đổi-khóa-diffie-hellman-dh)
*   [8\. TLS 1.3 - Nhanh hơn, An toàn hơn](#-tls-13---nhanh-hơn-an-toàn-hơn)
*   [9\. Tổng kết](#-tổng-kết)
