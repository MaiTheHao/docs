...
*   [1. Vấn đề Gốc rễ: Sự lãng phí Băng thông](#vấn-đề-gốc-rễ-sự-lãng-phí-băng-thông)
*   [2. Giải pháp của Nagle: "Chờ đã!"](#giải-pháp-của-nagle-chờ-đã)
*   [3. Cách Nagle Gây trễ (Vấn đề Hiệu suất)](#cách-nagle-gây-trễ-vấn-đề-hiệu-suất)
*   [4. Giải pháp: Tắt Nagle bằng `TCP_NODELAY`](#giải-pháp-tắt-nagle-bằng-tcp_nodelay)
*   [5. Tổng kết](#tổng-kết)
