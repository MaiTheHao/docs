...
![One codebase maps to many deploys](./assets/codebase-deploys.png)
...
![A production deploy attached to four backing services.](./assets/attached-resources.png)
...
![Scale is expressed as running processes, workload diversity is expressed as process types.](./assets/process-types.png)
